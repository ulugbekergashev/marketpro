  ...
  return (
    <section className="relative min-h-screen bg-[#020617] text-white overflow-hidden flex items-center pt-8 pb-12 lg:pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-blue-600/10 rounded-full blur-[120px] mix-blend-screen animate-pulse duration-10000"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start">
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-5 py-2 backdrop-blur-md shadow-lg shadow-blue-500/10"
            >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight uppercase"
            >
              Marketpleysda <br />
            ...
            <motion.p
              ...
              className="text-base md:text-lg text-slate-400 max-w-lg leading-relaxed font-medium"
            >
            ...
            <motion.div
              ...
              className="flex flex-col w-full sm:w-auto sm:flex-row gap-4 pt-4"
            >
              <a
                href="#contact"
              ...
              <a
                ...
                className="w-full sm:w-auto bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold py-4 px-8 rounded-xl transition-all flex items-center justify-center gap-2 backdrop-blur-sm cursor-pointer group"
              >
                <span className="relative flex items-center gap-2 uppercase tracking-wider text-sm">
          ...
          <motion.div
            ...
            className="relative h-[400px] lg:h-[650px] flex items-center justify-center mt-8 lg:mt-0"
          >
            {/* Decorative circles behind image */}
            <div className="absolute w-[350px] lg:w-[600px] h-[350px] lg:h-[600px] border border-white/5 rounded-full animate-[spin_20s_linear_infinite]"></div>
            <div className="absolute w-[300px] lg:w-[500px] h-[300px] lg:h-[500px] border border-blue-500/10 rounded-full animate-[spin_25s_linear_infinite_reverse]"></div>

            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-purple-500/20 blur-[100px] rounded-full"></div>
            ...
            <div className="relative z-10 w-full max-w-[320px] lg:max-w-[500px] aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-[#0B1121] group">
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-4 lg:bottom-8 left-4 lg:left-8 right-4 lg:right-8 bg-white/10 backdrop-blur-xl border border-white/20 p-4 lg:p-5 rounded-2xl flex items-center justify-between shadow-xl">
                <div>
