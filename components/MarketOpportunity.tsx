        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex items-center justify-between group hover:border-yellow-500/30 transition-colors">
                <div>
                  <div className="text-white font-bold text-lg">Yandex Market</div>
                  <div className="text-sm text-slate-500">Sotuv hajmi</div>
                </div>
                <div className="text-right">
                  <span className="text-yellow-400 font-bold text-xl flex items-center justify-end gap-1">+180% <TrendingUp className="w-5 h-5" /></span>
              ...
              <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex items-center justify-between group hover:border-blue-500/30 transition-colors">
                <div>
                  ...
                  <div className="text-sm text-slate-500">Buyurtmalar soni</div>
                </div>
                <div className="text-right">
                  <span className="text-blue-400 font-bold text-xl flex items-center justify-end gap-1">+215% <TrendingUp className="w-5 h-5" /></span>
                  <span className="text-xs text-slate-500">yillik o'sish</span>
                </div>
              </div>

              <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex items-center justify-between group hover:border-blue-400/30 transition-colors">
                <div>
                  <div className="text-white font-bold text-lg">Ozon</div>
                  <div className="text-sm text-slate-500">Bozorga kirish</div>
                </div>
                <div className="text-right">
                  <span className="text-blue-300 font-bold text-xl flex items-center justify-end gap-1">TOP-3 <TrendingUp className="w-5 h-5" /></span>
                  <span className="text-xs text-slate-500">bozor yetakchisi</span>
                </div>
              </div>
            </div>
          </div>
